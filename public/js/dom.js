function recherche() {
    ...
    console.log(num);
    window.location.href = "/BanqueDuPeuple/src/controller/compteController.php?num=" + num;
}

function rechercheClient() {
    var cni = document.getElementById("cniClient").value;
    window.location.href = "/BanqueDuPeuple/src/view/indexFinance.php?view=rechClient&cni=" + cni;
}
